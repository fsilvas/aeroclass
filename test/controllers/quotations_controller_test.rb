...
class QuotationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create quotation" do
    assert_difference('Quotation.count') do
      post quotations_url, params: { quotation: { price: @quotation.price, quotation_date: @quotation.quotation_date, status: @quotation.status } }
    end
  ...
  test "should update quotation" do
    patch quotation_url(@quotation), params: { quotation: { price: @quotation.price, quotation_date: @quotation.quotation_date, status: @quotation.status } }
