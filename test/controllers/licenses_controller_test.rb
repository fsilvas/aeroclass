...
class LicensesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create license" do
    assert_difference('License.count') do
      post licenses_url, params: { license: { euro_cost: @license.euro_cost, name: @license.name, usd_cost: @license.usd_cost } }
    end
  ...
  test "should update license" do
    patch license_url(@license), params: { license: { euro_cost: @license.euro_cost, name: @license.name, usd_cost: @license.usd_cost } }
